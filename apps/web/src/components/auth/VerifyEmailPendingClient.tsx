...
//  - Spam/offers warning
//  - 24h expiry info
//  - Sentry-free (pure client UX component)

import { useEffect, useState, useRef } from 'react'
import { Mail, RefreshCw, ExternalLink, AlertTriangle, CheckCircle2, Clock, ChevronLeft, Inbox } from 'lucide-react'
...
export function VerifyEmailPendingClient({ email }: Props) {
  // Cooldown state — start at COOLDOWN_S (email just sent on register)
